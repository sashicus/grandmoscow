...
import { updateProperty } from '../data/mockData';
...
const EditProperty: React.FC<EditPropertyProps> = ({ property, onBack, onUpdateProperty }) => {
  const { user } = useAuth();
  ...
  if (!user || user.type !== 'realtor' || property.realtorId !== user.id) {
    return null;
  }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedProperty: Property = {
      ...
      priceType: formData.priceType as 'day' | 'month' | 'year',
            ...
            <div className="grid md:grid-cols-5 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, priceType: e.target.value as 'day' | 'month' | 'year' }))}
